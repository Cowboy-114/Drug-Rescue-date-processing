...
neg<-read.csv("11529-AS-0008_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
low<-read.csv("11529-AS-0007_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
med<-read.csv("11529-AS-0006_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
high<-read.csv("11529-AS-0005_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
write.csv(e,file = "C:/Users/KRONCKE/OneDrive - VUMC/Kroncke_Lab/kcnh2/sequencing/VANTAGE/DrugRescue/alex/sort-files/11529_e_e4031.csv")
