...
neg<-read.csv("11247-AS-0012_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
low<-read.csv("11247-AS-0011_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
med<-read.csv("11247-AS-0010_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
high<-read.csv("11247-AS-0009_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
write.csv(e,file = "C:/Users/KRONCKE/OneDrive - VUMC/Kroncke_Lab/kcnh2/sequencing/VANTAGE/DrugRescue/alex/sort-files/11247_e_eva.csv")
