...
neg<-read.csv("11362-AS-0024_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
low<-read.csv("11362-AS-0023_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
med<-read.csv("11362-AS-0022_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
high<-read.csv("11362-AS-0021_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
write.csv(e,file = "C:/Users/KRONCKE/OneDrive - VUMC/Kroncke_Lab/kcnh2/sequencing/VANTAGE/DrugRescue/alex/sort-files/11362_e_e4031.csv")
