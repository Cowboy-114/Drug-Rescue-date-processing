...
neg<-read.csv("11529-AS-0004_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
low<-read.csv("11529-AS-0003_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
med<-read.csv("11529-AS-0002_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
high<-read.csv("11529-AS-0001_S1_L005.sorted_bc.processed.csv",header=TRUE,stringsAsFactors=FALSE)
...
write.csv(e,file = "C:/Users/KRONCKE/OneDrive - VUMC/Kroncke_Lab/kcnh2/sequencing/VANTAGE/DrugRescue/alex/sort-files/11529_e_dmso.csv")
