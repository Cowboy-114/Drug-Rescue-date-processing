...
d.dmso <- read.csv("C:/Users/KRONCKE/OneDrive - VUMC/Kroncke_Lab/kcnh2/sequencing/VANTAGE/Tile3/Tile3-DMS.csv")
...
d.tot$color <- ifelse(d.tot$score.dmso < 40 & d.tot$score.eva > 40, "blue",
                      ifelse(d.tot$score.dmso < 40, "black", NA))
